...
async def pms_room_status(request: Request, db: Session = Depends(get_db)):
...
async def pms_room_history(request: Request, db: Session = Depends(get_db)):
...
async def pms_crm_dashboard(request: Request, db: Session = Depends(get_db)):
...
async def pms_crm_guest_detail(request: Request, guest_id: int, db: Session = Depends(get_db)):
...
async def pms_guest_history(request: Request, guest_id: int = None, db: Session = Depends(get_db)):
