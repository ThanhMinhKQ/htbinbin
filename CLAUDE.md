...
This project is indexed by GitNexus as **binbinops** (14343 symbols, 20291 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
