export default {
    ...
    async fetchHistory(page = 1) {
        ...
        // [CHANGE] Use dest_warehouse_id for Requests List (Requests *TO* my warehouse)
        let url = `/api/inventory/requests?dest_warehouse_id=${this.currentWarehouseId || 0}&page=${page}&per_page=${this.perPage}`;
