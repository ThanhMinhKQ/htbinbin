...
function pmsRdRenderFolioTabs() {
    ...
    let actionsHtml = rdCurrentFolios.length > 1
        ? `<div class="rd-folio-actions"><button class="rd-folio-btn" onclick="rdPayOpenMergeFolio()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M19 12l-7 7-7-7"/></svg>Gộp Bill</button></div>`
        : '';
...
async function rdPayPrintFolio() {
    ...
    try {
        ...
        // If folio already has structured invoice info, print directly
