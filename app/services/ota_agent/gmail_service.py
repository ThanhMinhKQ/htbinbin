...
class GmailService:
    ...
    def watch_inbox(self) -> Optional[Dict]:
        ...
        try:
            ...
            if result.get('historyId'):
                ...
                self._save_last_history_id_to_db(self._last_history_id)
                logger.info(
    ...
    BOOKING_KEYWORDS = [
        ...
        # Go2Joy/G2J specific
        'đặt chỗ thành công', 'booking thành công', 'g2j', 'go2joy',
    ]
    ...
    SKIP_KEYWORDS = [
        ...
        'otp', 'token', 'one time password', 'verification code',
    ...
    def get_watch_status(self) -> Dict:
        ...
        return {
            ...
            "last_history_id": self._last_history_id or self._get_last_history_id_from_db(),
