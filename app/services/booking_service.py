...
class BookingService:
    ...
    def serialize(self, booking: Booking) -> Dict[str, Any]:
        ...
        return {
            ...
            "branch_address": raw.get("branch_address") or (booking.branch.address if booking.branch else None),
            "branch_phone": booking.branch.phone if booking.branch else None,
            "branch_bank_name": booking.branch.bank_name if booking.branch else None,
            "branch_bank_account": booking.branch.bank_account if booking.branch else None,
            "branch_bank_holder": booking.branch.bank_holder if booking.branch else None,
            "branch_personal_bank_name": booking.branch.personal_bank_name if booking.branch else None,
            "branch_personal_bank_account": booking.branch.personal_bank_account if booking.branch else None,
            "branch_personal_bank_holder": booking.branch.personal_bank_holder if booking.branch else None,
            "guest_id": booking.guest_id,
